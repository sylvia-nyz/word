...
public class MyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list_my=(ListView)findViewById(R.id.list_my);
        back=(Button)findViewById(R.id.back_my);
        ...
        //输出我的单词本中的单词：
        /*
        ArrayList<Map<String, String>> items = getAll("mywords");
        ...
        this.registerForContextMenu(list_my);
    }
    ...
    private void DeleteUserSql(String strId) {
        String sql = "delete from mywords where _ID='" + strId + "'";
    ...
    private void DeleteDialog(final String strId) {
        new AlertDialog.Builder(this)
                ...
                .setNegativeButton("取消", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(MyActivity.this, "取消删除", Toast.LENGTH_LONG).show();
                    }
                })
                .create().show();
    }
    ...
    private void UpdateUserId(String strId, String strWord, String strMeaning, String strSample) {
        ...
        String sql = "update mywords set word=?,meaning=?,sample=? where _ID=?";
    ...
    private void Update(String strId, String strWord, String strMeaning, String strSample) {
        ...
        String selection = Words.Word._ID +"= ?";
        String[] selectionArgs = {strId};
        int count = db.update("mywords", values, selection, selectionArgs);
    }
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        Toast.makeText(MyActivity.this, "更新成功", Toast.LENGTH_LONG).show();
                    }
                })
                .setNegativeButton("取消", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(MyActivity.this, "取消更新", Toast.LENGTH_LONG).show();
                    }
                })
                .create()
                .show();
